		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-6 col-xl-2">
					<h1 class="mb-0">
						<a href="index.html" class="text-black h2 mb-0">New Driver</a>
					</h1>
				</div>
			...
			<div class="container">
				<div class="col-md-12 col-lg-12 mb-5">
					...
					<form:form action="${action}" class="p-5 bg-white" method="POST"
						...
						<form:hidden path="idDriver"/>
						<div class="row form-group">
							<div class="col-md-12 mb-3 mb-md-0 style="text-align:center;>
								<div style="width: 40%; margin-left: 0%;">
									<label class="font-weight-bold" for="fullname">Name Of Driver</label>
									<form:input path="nameDriver" type="text" id="fullname"
										class="form-control" required="required"
										placeholder="eg. Tran Khanh Tuan" />
								</div>
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-12 mb-3 mb-md-0 style="text-align:center;>
								<div style="width: 40%; margin-left: 0%;">
									<label class="font-weight-bold" for="jobname">Phone</label>
									<form:input path="tel" type="text" id="jobname"
										class="form-control" required="required"
						...
						<div class="row form-group">
							...
							<div class="col-md-12 mb-3 mb-md-0">
								<form:textarea path="exp" name="" class="form-control" id=""
